...
[easyicon](https://www.easyicon.net/)(海量的图标文件)
...
[ATOM常用的插件](https://www.jianshu.com/p/eac1879cb2e9)
...
[desktoppr](https://www.desktoppr.co/wallpapers)(一个好看的背景图片网站)

[px2rem](http://pxtoem.com/)(在线的转换工具)

[npm download](https://awehunt.com/npmdownloads?ids=react,angular,vue)(npm包下载量曲线图)

[wiki How](https://zh.wikihow.com/%E9%A6%96%E9%A1%B5)(可以编辑的指导手册)

[常用网站配色](https://flatuicolors.com/palette/defo)(20种常见配色)

[FlatUI](https://flatuicolors.com/)(常见网站配色)

[MikuTools](https://miku.tools/)(MikuTools - 一个轻量的工具集合)

[DATAV.GeoAtlas](http://datav.aliyun.com/tools/atlas/#&lat=25.16517336866393&lng=99.052734375&zoom=3)(地图选择器, 获取子区域)

[Css常用的特效动画](https://qishaoxuan.github.io/css_tricks/)(css tricks)

[LintCode](https://www.lintcode.com/)(领扣, 刷题-刷题-刷题)

[Linux 运维日志](https://www.centos.bz/)

[Bit.dev](https://bit.dev/)(组件展示库)

[Dev](https://dev.to/)(前端开发者社区)
...
### NPM
[NPM 中文网](https://www.npmjs.com.cn/)(account: wuhong, pwd: wuhong5201314)
...
[腾讯IMWeb团队](https://juejin.im/user/58c76a0a8ac247072013ce93)

### 工具
[BootCDN](https://www.bootcdn.cn/)

[jsDelive](https://www.jsdelivr.com/)(cdn地址)
...
[视频采集](http://www.gnet.com.cn/)(视频采集)

[devdocs](https://devdocs.io/)(在线api查询)
...
[css-tricks](https://css-tricks.com/)(不单单只是css snippets)
...
[cnode社区的api](https://cnodejs.org/api)
